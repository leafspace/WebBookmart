...
<html>
    <head>
        ...
        <link href="css/user-argm.css" rel="stylesheet"/>
    ...
    <body>
        <div id="all">
            ...
            <div id="agreement">
                <b>一、总则</b><br />
                1.1 云收藏的所有权和运营权归leafspace科技有限公司所有。<br />
                1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与云收藏之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。<br />
                1.3 本协议则可由云收藏随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。<br />
                <b>二、服务内容</b><br />
                2.1 云收藏的具体内容由本站根据实际情况提供。<br />
                2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。<br />
                <b>三、用户帐号</b><br />
                3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。云收藏有权对会员的权限设计进行变更。<br />
                ...
                6.3 使用本站的任何内容均应注明“来源于云收藏”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。<br />
                ...
                <b>七、责任声明</b><br />
                7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，云收藏对此不承担任何责任。<br />
